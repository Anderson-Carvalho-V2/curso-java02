...
public class Progam {
	...
	public static void main(String[] args) {
		...
		//Essa opeção da erro de tipos incopativéis.
		//BuinessAccount acc5 = (BuinessAccount)acc3;
		
		if(acc3 instanceof BuinessAccount) {
			BuinessAccount acc5 = (BuinessAccount)acc3;
			acc5.loan(200.0);
		...
		*/
		...
		Account acc2 = new SavingsAccount(1002, "Maria", 1000.00, 0.1);
		acc2.saque(200.00);
		System.out.println(acc2.getBalance());
		
		Account acc3 = new BuinessAccount(1003, "Bob", 1000.0, 500.0);
		acc3.saque(200.0);
